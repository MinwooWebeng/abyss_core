...
extern __declspec(dllexport) int World_GetURL(uintptr_t h, char* buf, int buflen);
...
extern __declspec(dllexport) int AbyssResponse_GetHeaders(uintptr_t h, char* buf, int buflen);
